                ...
                <div class="card-body">
                    <form action="/kontribusi/{{ $need->slug }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Isi nama penyedia" name="name" id="name" value="{{ old('name', $need->name)}}">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('category_id') is-invalid @enderror" placeholder="Isi kategori kebutuhan" name="category_id" id="category_id">
                                ...
                                <option value="{{ $category->slug }}" {{ $category->id === $need->category_id ? 'selected' : '' }}>{{ $category->name }}</option>
                                @endforeach
                            </select>
                            @error('category_id')
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" placeholder="Isi alamat penyedia" name="address"  rows="5">{{ old('address', $need->address)}}</textarea>
                            @error('address')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('hp') is-invalid @enderror" placeholder="Isi nomor kontak penyedia" name="hp" id="hp" value="{{ old('hp', $need->hp) }}">
                            @error('hp')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
